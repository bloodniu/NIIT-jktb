...
value = number
xxx = str(hex(0x5e528599eeb8c80000000000 ))[2:]                      #个人身份编码7786
yyy = str(hex(0x5e5285946dd054f090000000 ))[2:]                      #班级身份编码8018
zzz = str(hex(0x5e5285946dd054f090000000 ))[2:]                      #学院身份编码8446
Class = ''
Name = Name
name = ''
telephone = ''
